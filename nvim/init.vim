...
" }}}
" === COMANDS === {{{
""https://github.com/haorenW1025/completion-nvim/blob/e81e51f92c933c2005ee4d6a4619b4c391ccd377/lua/utility.lua
"
hi def link WhidHeader      Number
hi def link WhidSubHeader   Identifier

command! Whid lua require('my.whid').whid()
" command! MyProjectStart lua require('my.project').start('')
...
" augroup myInit
"   autocmd!
"   autocmd VimEnter * lua require('my.whid').whid()
...
local pProject = 'dots'
local pGitProjectsDir = '/home/gmack/projects'
local pGitOwner = 'grantmacken'
local pGitOwnerDir = pGitProjectsDir .. '/' .. pGitOwner
local pRoot = pGitOwnerDir .. '/' .. pProject
vim.loop.chdir(pRoot)

local pFile = pRoot .. '/' .. 'README.md'
local api = vim.api

local myProject = require('my.project')
cmdline_complete_nav      = myProject.cmdline_complete_nav
cmdline_complete_projects = myProject.cmdline_complete_projects
